...
enum SettingsFormatFixture {
    ...
    static let allKeys: [String] = [
        ...
        "dailiesBurnClipName", "dailiesBurnCustom", "dailiesBurnDate",
        "dailiesBurnProject", "dailiesBurnTimecode", "dailiesClipNamePosition",
        ...
        "remoteEnabled", "remoteLivePIN", "remotePIN",
