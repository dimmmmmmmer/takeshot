...
enum SettingsFormatFixture {
    ...
    static let allKeys: [String] = [
        ...
        "dailiesCodec", "dailiesCustomPosition", "dailiesCustomText",
        "dailiesDatePosition", "dailiesDestinationPath", "dailiesNamePrefix",
        "dailiesNameSuffix", "dailiesProjectPosition", "dailiesTimecodePosition",
