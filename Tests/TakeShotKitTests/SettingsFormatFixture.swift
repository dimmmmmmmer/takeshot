...
enum SettingsFormatFixture {
    ...
    static let allKeys: [String] = [
        ...
        "dailiesDestinationPath", "dailiesNamePrefix", "dailiesNameSuffix",
        "dailiesPlateOpacity", "dailiesProjectPosition", "dailiesTextOpacity",
        "dailiesTimecodePosition", "defaultMarkerColor", "desqueezeFactor",
        "desqueezeOn", "destinationPath", "detectionMode",
        "forcedInputMode", "forcedInputRGB", "framelineRatio",
        "framelinesOn", "hdrMode", "keepInMenuBar",
        "legendPlacement", "legendSize", "ltcChannel",
        "lutFileName", "lutFolderPath", "lutIntensity",
        "lutPreviewEnabled", "lutRecordEnabled", "monitorDeviceID",
        "monitorDimmed", "monitorEnabled", "monitorMuted",
        "monitorVolume", "namingPane", "namingTemplate",
        "ndiEnabled", "ndiSourceName", "offerMountedCards",
        "offloadDestinationPaths", "peakingColor", "peakingIntensity",
