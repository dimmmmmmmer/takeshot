...
enum SettingsFormatFixture {
    ...
    static let allKeys: [String] = [
        ...
        "dailiesClipNamePosition", "dailiesCustomPosition",
        "dailiesCustomText", "dailiesDestinationPath",
        "dailiesProjectPosition", "dailiesTimecodePosition", "defaultMarkerColor",
        ...
        "lutFileName", "lutFolderPath", "lutIntensity", "lutPreviewEnabled",
        "lutRecordEnabled",
        "monitorDeviceID", "monitorDimmed", "monitorEnabled", "monitorMuted",
        "monitorVolume", "namingPane", "namingTemplate", "ndiEnabled",
        "ndiSourceName",
