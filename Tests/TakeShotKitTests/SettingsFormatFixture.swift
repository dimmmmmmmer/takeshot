...
enum SettingsFormatFixture {
    ...
    static let allKeys: [String] = [
        ...
        "schemaVersion", "srtAddress", "srtBitrateMbps",
        "srtEnabled", "srtLatencyMs", "srtPassphrase",
        "srtPort", "srtRole", "srtStreamID",
        "startDebounceFrames", "stopDebounceFrames", "tenBitCapture",
        "timecodeSource", "videoLevels", "visualRecCenterX",
