...
enum SettingsFormatFixture {
    ...
    static let allKeys: [String] = [
        ...
        "peakingColor", "peakingIntensity", "playbackAudioDeviceUID",
        "playerBackgroundHex", "postfix", "preRollFrames",
        "preRollSeconds", "preRollUnit", "projectName",
        "r3dApplyCameraLUT", "r3dDecodeScale", "remoteEnabled",
        "remotePIN", "remotePort", "safeActionPercent",
        "safeAreasOn", "safeTitlePercent", "schemaVersion",
        "srtAddress", "srtBitrateMbps", "srtEnabled",
        "srtLatencyMs", "srtPassphrase", "srtPort",
