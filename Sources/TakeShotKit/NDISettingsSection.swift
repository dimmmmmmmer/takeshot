...
/// section and for the same reason — that view is the densest localized surface
/// in the app and sits at the file-length ceiling.
///
...
/// CaptureCore/CDeckLink error: they name a file to download and a directory to
/// put it in, and a translated path is a worse instruction than the path.
